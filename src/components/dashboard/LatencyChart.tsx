...
export function LatencyChart({ points, range, className }: LatencyChartProps) {
  ...
  return (
    <div data-reveal className={cn('rounded-md border bg-card p-5 shadow-[var(--shadow-whisper)]', className)}>
      <div className="flex flex-wrap items-baseline justify-between gap-3">
        <div>
          <h3 className="font-display text-base font-semibold text-ink">Latencia</h3>
          <p className="text-sm text-muted-foreground">Promedio y percentil 95 de la flota</p>
        </div>
